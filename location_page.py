...
class LocationPage:
    ...
    def create_case_plots(self):
        ...
        recent_titles = {'figure': f'{self.name} Case Data - Previous Two Weeks',
                         'y': 'Daily Cases'}
        self.case_fig_html = plotting.plot_cases(self.cases.cases,
                                                 self.cases.cases_avg_new,
                                                 case_titles
                                                 )
        self.recent_cases_fig_html = plotting.plot_cases(self.recent_cases.cases,
    ...
    def create_death_plots(self):
        ...
        recent_titles = {'figure': f'{self.name} Death Data - Previous Two Weeks',
                         'y': 'Daily Deaths'}
        self.death_fig_html = plotting.plot_deaths(self.deaths.deaths,
                                                   death_titles
                                                   )
